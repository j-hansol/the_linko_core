...
use App\Http\JsonResponses\V1\Base\TokenResponse;
use App\Http\Requests\V1\RequestCertificationToken;
use App\Http\Requests\V1\RequestChangePassword;
use App\Http\Requests\V1\RequestFacebookLogin;
use App\Http\Requests\V1\RequestJoinOrganization;
use App\Http\Requests\V1\RequestJoinPerson;
use App\Http\Requests\V1\RequestLogin;
use App\Http\Requests\V1\RequestLoginAuto;
use App\Http\Requests\V1\RequestResetPassword;
use App\Http\Requests\V1\RequestUpdateDevice;
use App\Http\Requests\V1\RequestUpdateOrganizationProfile;
use App\Http\Requests\V1\RequestUpdatePersonProfile;
...
class UserController extends Controller {
    ...
    public function getMyInfo() : JsonResponse {
        try {
            $service = UserService::getInstance();
            return $service->getMyInfo()?->response();
        } catch (HttpException $e) {
            return new Message($e->getCode());
        } catch (\Exception $e) {
            return new Message(500);
