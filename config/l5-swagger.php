...
return [
    ...
    'documentations' => [
        'v1' => [
            'api' => ['title' => '더 링코 코어 (The Linko Core) Api V1'],
            ...
            'paths' => [
                ...
                'annotations' => [
                    base_path('app/Http/Requests/V1'),
                    base_path('app/Http/JsonResponses/Common'),
                    base_path('app/Http/JsonResponses/V1'),
                    base_path('app/Http/QueryParams'),
                    base_path('app/DTOs/V1'),
                    base_path('app/Lib'),
                    base_path('app/Models'),
                    base_path('app/Traits/Common'),
                    base_path('app/Traits/V1'),
                    base_path('app/Http/Controllers/Api/V1')
                ]
            ]
        ],
        'v2' => [
            'api' => ['title' => '더 링코 코어 (The Linko Core) Api V2'],
            ...
            'paths' => [
                ...
                'format_to_use_for_docs' => env('L5_FORMAT_TO_USE_FOR_DOCS', 'json'),
                'annotations' => [
                    base_path('app/Http/Requests/V2'),
                    base_path('app/Http/JsonResponses/Common'),
                    base_path('app/Http/JsonResponses/V2'),
                    base_path('app/Http/QueryParams'),
                    base_path('app/DTOs/V2'),
                    base_path('app/Lib'),
                    base_path('app/Models'),
                    base_path('app/Traits/Common'),
                    base_path('app/Traits/V2'),
